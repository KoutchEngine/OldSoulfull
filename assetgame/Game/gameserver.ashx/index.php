...
local PlayerCount = 0
local placeVisitAccessKey = game.JobId
...
if not success then
print("server now gonna die, reason: "..errorMsg)
game:HttpGet("http://api.<?= $url; ?>/Game/RCCUpdate.php?job="..game.JobId.."&players=0".."&port="..port)
end
end
