;// bundle: leanbase___a0765fbd3daca3bbdd81f05520d6a639_m
;// files: leancore/libs/bootstrap.min.js, leancore/BootstrapNamespacing.js, GoogleAnalytics/GoogleAnalyticsEvents.js, JSErrorTracker.js, RobloxEventManager.js, GoogleEventListener.js, SiteTouchEvent.js, UpsellAdModal.js, JavaScriptEndpoints.js, utilities/deviceFeatureDetection.js, XsrfToken.js, DeveloperConsoleWarning.js, leancore/iesupport/jquery.placeholder.js, jquery.ba-postmessage.min.js, widgets/jquery.mCustomScrollbar.concat.min.js, leancore/Navigation.js, Reference/widget.js, CookieUpgrader.js, Game/GamePlayEvents.js, IframeEventListener.js, leancore/RobloxBaseInit.js, jquery.tipsy.js, extensions/string.js, StringTruncator.js, json2.min.js, MasterPageUI.js, polyfill/ie7localStorage.js, jPlayer/2.9.2/jquery.jplayer.min.js, jquery.simplemodal-1.3.5.js, AjaxAvatarThumbnail.js, extensions/Thumbnails.js, extensions/ThreeDeeThumbnails.js, Thumbnails/ThumbnailView.js, Linkify.js, CookieUpgrader.js, utilities/stringFormat.js, Tracking/SignupTrackingScript.js, Tracking/AsyncGoogleOnScript.js, VideoPreRollDFP.js, CharacterSelect.js, MadStatus.js, PlaceLauncher.js, ABPlaceLauncher.js, GameLauncher.js, GameLaunchLogger.js, ProtocolHandlerClientInterface.js, GameLaunchAdRefresher.js, JSErrorTracker.js
 ...
 * Config saved to config.json and http://gist.github.com/b8480475c6c7b955a207
 */
...
Roblox.JSErrorTracker = {
    ...
    errorHandler: function(n, t, i) {
        try {
            Roblox.JSErrorTracker.data.msg = n,
...
Roblox.SiteTouchEvent = function() {
    function i() {
        var t, i;
        return localStorage == null ? new Date(0) : (typeof localStorage != "undefined" && (t = localStorage.getItem(n)),
        (typeof t == "undefined" || t === null) && (t = $.cookie(n)),
        i = Date.parse(t),
        t && !isNaN(i) ? new Date(i) : new Date(0))
    }
    function r(i) {
        localStorage != null && (typeof i == "undefined" && (i = new Date),
        typeof localStorage != "undefined" && (t.useLocalStorage ? $.cookie(n, null) : localStorage.removeItem(n)),
        t.useLocalStorage && typeof localStorage != "undefined" ? localStorage.setItem(n, i) : $.cookie(n, i, {
            expires: 100
        }))
    }
    function u() {
        var n = i();
        Math.floor((new Date - n) / 36e5) >= t.dateDiffThresholdInHours && RobloxEventManager.triggerEvent("rbx_evt_sitetouch"),
        r()
    }
    var n = "LastActivity"
      , t = {
...
Roblox.DeviceFeatureDetection = function() {
    function t() {
        ("ontouchstart"in window || "onmsgesturechange"in window || navigator.MaxTouchPoints > 0 || navigator.mxMaxTouchPoints > 0) && (n = !0,
        $(".container-main").addClass("touch"))
    }
    var n = !1;
    return t(),
    {
...
Roblox.XsrfToken = function() {
    ...
    var n = "", t = "X-CSRF-TOKEN", r = 403, i;
    return $(document).ajaxSend(function(t, i, r) {
        n !== "" && r.type.toLowerCase() === "post" && i.setRequestHeader("X-CSRF-TOKEN", n)
    }),
    $.ajaxPrefilter(function(i) {
        if (i.dataType != "jsonp" && i.dataType != "script" && n !== "") {
            var e = i.error;
            i.error = function(u, f, o) {
                if (u.status == r && u.getResponseHeader(t) != null) {
                    var s = u.getResponseHeader(t);
                    if (s == null) {
                        typeof e == "function" && e(u, f, o);
...
;// leancore/iesupport/jquery.placeholder.js
...
$(function() {
    ...
    function h() {
        var r = w(), u = v(), t = u + r, n = $(".rbx-nav-collapse .notification-red"), i;
    ...
    function l() {
        ...
        $.ajax({
            ...
            success: function(n) {
                ...
                i.attr("href", n.FriendNavigationUrl),
                i.data("count", n.TotalFriendRequests),
                t.html(n.DisplayCountFriendRequests),
                t.attr("title", n.TotalFriendRequests),
                n.TotalFriendRequests > 0 ? t.removeClass("hide") : t.addClass("hide"),
                h(n.TotalFriendRequests)
            }
        })
    }
    function p(n) {
    ...
    $(document).on("Roblox.Messages.CountChanged", function() {
        ...
        $.ajax({
            url: n,
            success: function(n) {
                var r = $("#nav-message"), t = $("#nav-message span.notification-blue"), i;
                r.data("count", n.count),
                i = o(n.count, s),
                t.html(i),
                t.attr("title", n.count),
                n.count > 0 ? t.removeClass("hide") : t.addClass("hide"),
                h()
            }
        })
    }).on("Roblox.Friends.CountChanged", l);
    ...
    var t = $("#navbar-universal-search")
      ...
      , y = $("#navbar-universal-search #navbar-search-btn");
    ...
    var u = function() {
      ...
      , a = function() {
        $("#head-login").click(function() {
            if ($("#iFrameLogin").toggleClass("show"),
            $("#iFrameLogin").hasClass("show")) {
                var t = $("#head-login").offset().left - $("#iFrameLogin").offset().left - 250;
                t > 0 && $("#iFrameLogin").css("left", t)
            }
        })
    }
      , c = $("#signupOrLoginIframe");
    c.length ? c.load(function() {
        u()
    }) : u(),
    a()
});
...
Roblox.BootstrapWidgets = function() {
    ...
    function w() {
        $('[data-toggle="collapsible-element"]').on("show.bs.collapse", function(n) {
            $(n.target).prev(".rbx-panel-heading").find(".icon-right-16x16").removeClass("icon-right-16x16").addClass("icon-down-16x16")
        });
        $('[data-toggle="collapsible-element"]').on("hide.bs.collapse", function(n) {
            $(n.target).prev(".rbx-panel-heading").find(".icon-down-16x16").removeClass("icon-down-16x16").addClass("icon-right-16x16")
        })
    }
    function p() {
    ...
    function n(n, t, i) {
        typeof n != "undefined" && (t = typeof t == "undefined" ? 200 : t,
    ...
    function f() {
        e.each(function() {
            ...
            n.width(i.width()),
            $("body").append(n),
            n.height() <= i.height() && (i.removeClass(t),
    ...
    function r(n, t) {
        ...
        $(".toggle-para").bind("click touchstart", function() {
            ...
            $(this).text() === n ? (u.removeClass(r).addClass(i),
            $(this).text(t)) : (u.removeClass(i).addClass(r),
            $(this).text(n))
        })
    }
    function k(n) {
...
typeof Roblox.GamePlayEvents == "undefined" && (Roblox.GamePlayEvents = function() {
    ...
    function n(n, i, u) {
        ...
        Roblox.EventStream.SendEvent(n, i, r(u)))
    }
    function u(t, i) {
        n("gamePlayIntent", t, i),
...
$(function() {
    $("body").on("mousedown", ".VisitButtonPlay, .VisitButtonPlayGLI, .VisitButtonPersonalServer, .VisitButtonPersonalServerGLI, .profile-join-game", function() {
        var n, t = $(this), i;
        t.hasClass("VisitButtonPlay") || t.hasClass("VisitButtonPlayGLI") ? n = "PlayButton" : t.hasClass("profile-join-game") ? n = "JoinUser" : (t.hasClass("VisitButtonPersonalServer") || t.hasClass("VisitButtonPersonalServerGLI")) && (n = "PersonalServer"),
        n && (i = $(this).attr("placeid"),
        Roblox.GamePlayEvents.SendGamePlayIntent(n, i))
    });
    $("body").on("mousedown", ".VisitButtonEdit, .VisitButtonEditGLI, .VisitButtonBuild, .VisitButtonBuildGLI", function() {
        var n = $(this).hasClass("VisitButtonEdit") || $(this).hasClass("VisitButtonEditGLI") ? "Edit" : "Build"
          , t = $(this).attr("placeid");
        Roblox.GamePlayEvents.SendDevelopIntent(n, t)
    });
    ...
    $("#build-page").on("mousedown", ".roblox-build-button", function() {
        var t = $(this), n;
        n = typeof t.data("asset-id") == "undefined" ? t.parents("table.item-table").data("item-id") : t.data("asset-id"),
        n && Roblox.GamePlayEvents.SendDevelopIntent("Build", n)
    })
});
...
$(function() {
    ...
    var n = function(n) {
        var i, r, t;
        n.indexOf("resizeFrame") != -1 ? (t = n.split(","),
        i = t[1] ? parseInt(t[1]) : null,
        Roblox.SignupOrLoginParent.resizeFrame(i)) : n.indexOf("resizeModal") != -1 ? (t = n.split(","),
        i = t[1] ? parseInt(t[1]) : null,
        Roblox.SignupOrLoginModal.resizeModal(i)) : n.indexOf("resize") != -1 ? (t = n.split(","),
        $("#iframe-login").css({
            height: t[1]
        })) : n.indexOf("fbRegister") != -1 ? (t = n.split("^"),
        r = "&fbname=" + encodeURIComponent(t[1]) + "&fbem=" + encodeURIComponent(t[2]) + "&fbdt=" + encodeURIComponent(t[3]),
        window.location.href = "../Login/Default.aspx?iFrameFacebookSync=true" + r) : n.indexOf("reload") != -1 && (n.indexOf(",") != -1 ? (t = n.split(","),
        window.location.href = t[1]) : window.location.reload())
    }
});
...
(typeof window.localStorage == "undefined" || typeof window.sessionStorage == "undefined") && function() {
    var n = function(n) {
        ...
        function i(t) {
            if (t = t.length ? JSON.stringify(t) : "",
            n == "session")
                window.name = t,
                r || (window.addEventListener ? window.addEventListener("unload", i, !1) : window.attachEvent && window.attachEvent("onunload", i),
                r = !0);
            else {
                var f = new Date;
                f.setTime(f.getTime() + 31536e6),
                document.cookie = u + "=" + t + "; expires=" + f.toGMTString() + "; path=/"
            }
        }
        var r = !1
          , u = "localStorage"
    ...
    typeof window.localStorage == "undefined" && (window.localStorage = new n("local")),
    typeof window.sessionStorage == "undefined" && (window.sessionStorage = new n("session"))
}();

;// jPlayer/2.9.2/jquery.jplayer.min.js
...
var RobloxThumbs = function() {
    ...
    return {
        GenerateAvatarThumb: function(t, i, r) {
            $("#" + t).attr("src", "/images/spinners/waiting.gif"),
            n(t, i, r)
        }
    }
}();
        ...
        function n(r) {
            ...
            u && $.ajax({
                ...
                success: function(u) {
                    if (u.Final) {
                        var f = r.find("img");
                        f.length === 1 ? f.attr("src", u.Url) : r.find("img.original-image").attr("src", u.Url),
                        r.removeAttr("data-retry-url")
                    } else
                        r.retryCount = r.retryCount ? r.retryCount + 1 : 1,
                        r.retryCount < i && setTimeout(function() {
                            n(r)
                        }, t)
                }
            })
...
(function() {
    ...
    function e(n) {
        var u = new THREE.AmbientLight(8882048), t, i, r;
        n.add(u),
        t = new THREE.DirectionalLight(11316396),
        t.position.set(-.671597898, .671597898, .312909544).normalize(),
        n.add(t),
        i = new THREE.DirectionalLight(4473924),
        r = (new THREE.Vector3).copy(t.position).negate().normalize(),
        i.position.set(r),
        n.add(i)
    }
    function u(n, t, i, r) {
    ...
    function d(n, t, r, u, f, o) {
        ...
        function ft() {
            var n = new THREE.OrbitControls(s,r.get(0),u);
            return et ? (n.autoRotate = !1,
            n.minDistance = .1,
            n.noPan = !1,
            n.noKeys = !1,
            n.noResetToInitialCameraPosition = !0) : (n.rotateSpeed = 1.5,
            n.zoomSpeed = 1.5,
            n.dynamicDampingFactor = .3),
        ...
        var a = h(r), it = "/thumbnail/resolve-hash/", et = i(r), g = new THREE.Vector3(u.aabb.max.x,u.aabb.max.y,u.aabb.max.z).length() * 4, nt = Math.max(g, p), s = new THREE.PerspectiveCamera(b,l() / c(),w,nt), v = new THREE.Scene, y, ot = new THREE.OBJMTLLoader;
        ot.load(it, n, t, tt, undefined, o)
    }
    var c = window.GoogleAnalyticsEvents && GoogleAnalyticsEvents.FireEvent || function() {}
      , b = 70
      , w = .1
      , p = 1e3
      , y = 500
                ...
                s = function() {
                    ...
                    function a() {
                        ...
                        s = setTimeout(function() {
                            o.addClass("text-center").html('<div class="loader" style="line-height:' + e.height() + 'px">Loading</div><div></div>')
                        }, y)
                    }
                    function p() {
                        c(),
                        o.hide().empty().removeClass("text-center")
                    }
                    function w(i) {
                        d(i.obj, i.mtl, e, i, function(t) {
                            r(e),
                            f || (p(),
                            e.append(t),
                            n(t))
                    ...
                    var h = e.data("3d-url"), o, s;
                    h && (r(e),
                    o = $('<div class="thumbnail-spinner">'),
                    o.appendTo(e),
                    a(),
                    u(h, w, i(e) ? l : v, i(e)))
                }
...
Roblox.ThumbnailView = function() {
    ...
    function f(n) {
        return !window.localStorage || !localStorage.setItem || !localStorage.getItem ? !1 : typeof n == "boolean" ? (localStorage.setItem(r, n.toString()),
        !0) : localStorage.getItem(r) == "true"
    }
    function s() {
    ...
    function e(r) {
        ...
        function p() {
            return g && typeof l().data("3d-thumbs-enabled") == "string"
        }
        function nt() {
            return !p()
        }
        ...
        function h(t) {
            ...
            f(t),
            e && e.cancel(),
            y().text(t ? "2D" : "3D").css("visibility", n() && a() ? "visible" : "hidden"),
            t && a())
                k(),
                c().hide(),
                e = s().load3DThumbnail(function(n) {
                    e = undefined,
                    i(["3D Thumbnail Loading", "Load succeeded"]),
                    r.find("canvas").not(n).remove()
                }, function() {
                    e = undefined,
                    i(["3D Thumbnail Loading", "Load failed"]),
                    w(),
                    h(!1)
                });
            else {
                b();
                var u = s().data("retry-url");
                u ? s().loadRobloxThumbnails() : c().attr("src", d)
            }
        }
        function v() {
            n() && a() || w(),
...
Roblox.Linkify = function() {
    ...
    function s(t) {
        return t.match(n.hasProtocolRegex) || (t = n.defaultProtocol + t),
        t
    }
    function h(n) {
        return n.replace("http://", "http://")
    }
    function c(t) {
        var f, u, i;
        return t = e(t),
    ...
    function l(i) {
        return t || u(),
        n.enabled && !f(i) && (i = i.replace(n.regex, c)),
        i
    }
    var n = {
        enabled: !1,
...
Roblox.VideoPreRollDFP = {
    ...
    onAdEvent: function(n) {
        ...
        case google.ima.AdEvent.Type.STARTED:
            ...
            t.length > 0) {
                var r = t[0]
                  , u = r.getContent()
                  , f = document.getElementById(Roblox.VideoPreRollDFP.companionAdDiv);
                f.innerHTML = u
            }
            break;
    ...
    checkEligibility: function() {
        Roblox.VideoPreRollDFP.showVideoPreRoll && (Roblox.VideoPreRollDFP.checkFlashEnabled() && (Roblox.VideoPreRollDFP.isFlashInstalled = !0),
        $("#PlaceLauncherStatusPanel").data("is-protocol-handler-launch-enabled") == "True" || Roblox.Client.IsRobloxInstalled() ? typeof google == "undefined" || typeof google.ima == "undefined" ? (Roblox.VideoPreRollDFP.videoLogNote = "NoGoogle",
        Roblox.VideoPreRollDFP.showVideoPreRoll = !1) : Roblox.Client.isIDE() ? (Roblox.VideoPreRollDFP.videoLogNote = "RobloxStudio",
        Roblox.VideoPreRollDFP.showVideoPreRoll = !1) : Roblox.Client.isRobloxBrowser() ? (Roblox.VideoPreRollDFP.videoLogNote = "RobloxPlayer",
        Roblox.VideoPreRollDFP.showVideoPreRoll = !1) : (window.chrome || window.safari) && window.location.hash == "#chromeInstall" && (Roblox.VideoPreRollDFP.showVideoPreRoll = !1) : Roblox.VideoPreRollDFP.showVideoPreRoll = !1)
    },
    ...
    isExcluded: function(n) {
        var i, t;
        if (typeof n == "undefined" && typeof play_placeId != "undefined" && (n = play_placeId),
        Roblox.VideoPreRollDFP.showVideoPreRoll && Roblox.VideoPreRollDFP.excludedPlaceIds !== "" && (i = Roblox.VideoPreRollDFP.excludedPlaceIds.split(","),
        typeof n != "undefined"))
            for (t = 0; t < i.length; t++)
                if (n == i[t])
                    return Roblox.VideoPreRollDFP.videoLogNote = "ExcludedPlace",
                    !0;
        return !1
    },
    start: function() {
...
Roblox.CharacterSelect = function() {
    function r() {
        return n.genderID = t.male,
        i(1, "Male", t.male),
        !1
    }
    function u() {
        return n.genderID = t.female,
        i(0, "Female", t.female),
        !1
    }
    function i(t, i, r) {
        $.modal.close(".GuestModePromptModal"),
        n.robloxLaunchFunction(r)
    }
    function f() {
    ...
    return $(function() {
        $(".VisitButtonGirlGuest").click(u),
        $(".VisitButtonBoyGuest").click(r)
    }),
    n = {
...
RobloxLaunch.StartGameWork = function(n, t, i, r, u) {
    ...
    try {
            ...
            try {
                ...
                try {
                    if (Roblox.Client._silentModeEnabled)
                        ...
                        s = Roblox.VideoPreRollDFP ? Roblox.VideoPreRollDFP : Roblox.VideoPreRoll,
        ...
        if (GoogleAnalyticsEvents.ViewVirtual("Visit/CreateLauncher/" + Roblox.Client._whyIsRobloxLauncherNotCreated),
        e = l.message,
        e === "User cancelled")
...
RobloxLaunch.CheckGameStarted = function(n, t) {
    function u() {
        ...
        try {
            ...
            r && !f && (EventTracker.endSuccess("StartClient"),
            ...
            e == "Windows" && (e = "Win32"),
            EventTracker.fireEvent("GameLaunchSuccessWeb_" + e),
            EventTracker.fireEvent("GameLaunchSuccessWeb_" + e + "_Plugin"),
            ...
            f = !0),
            o = Roblox.VideoPreRollDFP ? Roblox.VideoPreRollDFP : Roblox.VideoPreRoll,
            r && !o.isPlaying()) {
...
RBX.PlaceLauncher.prototype = {
    _showDialog: function() {
        ...
        n = Roblox.VideoPreRollDFP ? Roblox.VideoPreRollDFP : Roblox.VideoPreRoll,
        this._popupID == "PlaceLauncherStatusPanel" && (n && n.showVideoPreRoll && !n.isExcluded() ? (this._popup = $("#videoPrerollPanel"),
    ...
    _onGameStatus: function(n) {
        ...
        n.status === 2)
            ...
            n.status === 4 && (EventTracker.endFailure("GetConnection"),
...
RobloxABLaunch.RequestGame = function(n, t, i) {
    RobloxPlaceLauncherService.LogJoinClick(),
    RobloxABLaunch.launcher === null && (RobloxABLaunch.launcher = new Roblox.ABPlaceLauncher),
    RobloxABLaunch.launcher.RequestGame(t, i)
}
,
RobloxABLaunch.RequestGroupBuildGame = function(n, t) {
    RobloxPlaceLauncherService.LogJoinClick(),
    RobloxABLaunch.launcher === null && (RobloxABLaunch.launcher = new Roblox.ABPlaceLauncher),
    RobloxABLaunch.launcher.RequestGroupBuildGame(t)
}
,
RobloxABLaunch.RequestGameJob = function(n, t, i) {
    RobloxPlaceLauncherService.LogJoinClick(),
    RobloxABLaunch.launcher === null && (RobloxABLaunch.launcher = new Roblox.ABPlaceLauncher),
    RobloxABLaunch.launcher.RequestGameJob(t, i)
}
,
...
Roblox.ABPlaceLauncher.prototype = {
    _onGameStatus: function(n) {
        if (n.status === 2)
            RobloxABLaunch.StartGame(n.joinScriptUrl, "Join", n.authenticationUrl, n.authenticationTicket);
        else if (n.status < 2 || n.status === 6) {
            var t = function(n, t) {
                t._onGameStatus(n)
            }
...
Roblox.GameLauncher = function() {
    ...
    function i(t, i, r) {
        n.gameLaunchInterface.buildGameInStudio(t, i, r)
    }
    function u() {
    ...
    function f(t, i) {
        ...
        r.isPartyLeader = n.partyInterface.isPartyLeader(),
        u = n.bcUpsellModalInterface.checkBcRequirement(r, i).then(n.genderFetcher.getCharacterGender).then(n.prerollPlayer.waitForPreroll).then(n.gameLaunchInterface.joinMultiplayerBuildGame)
    }
    function e(t) {
        var i = {
            userId: t
    ...
    $(function() {
        ...
        n.genderFetcher || typeof Roblox.GenderFetcher == "undefined" || (n.genderFetcher = Roblox.GenderFetcher),
        n.prerollPlayer || typeof Roblox.PrerollPlayer == "undefined" || (n.prerollPlayer = Roblox.PrerollPlayer),
        n.partyInterface || typeof Roblox.PartyInterface == "undefined" || (n.partyInterface = Roblox.PartyInterface),
    ...
    $.fn.bindGameLaunch = function() {
        return this.find(".VisitButtonPlayGLI").click(function() {
            var n = $(this)
              , t = n.attr("placeid")
              , i = n.data("is-membership-level-ok");
            r(t, i)
        }),
        this.find(".VisitButtonPersonalServerGLI").click(function() {
            var n = $(this)
              , t = n.attr("placeid")
              , i = n.data("is-membership-level-ok");
            f(t, i)
        }),
        this.find(".VisitButtonBuildGLI").click(function() {
            var n = $(this)
              , t = n.attr("placeid")
              , r = n.data("universeid")
...
Roblox.PrerollPlayer = {
    waitForPreroll: function(n) {
        var r = new $.Deferred, t = Roblox.VideoPreRollDFP ? Roblox.VideoPreRollDFP : Roblox.VideoPreRoll, i, u;
...
;// ProtocolHandlerClientInterface.js
Roblox = Roblox || {},
Roblox.ProtocolHandlerClientInterface = function() {
    function d(n, t) {
        var i = function() {
            clearTimeout(r),
            n()
    ...
    function ot() {
        $.modal.close(),
        Roblox.GenericModal.open("Error starting game", null, "An error occurred trying to launch the game.  Please try again later.")
    }
    function et(n, t) {
        ...
        $("#ProtocolHandlerInstallButton").click(function() {
            var n, i;
            $(".style2016").length > 0 ? (i = $(".ph-install-step").length,
            n = i * $(".ph-install-step").outerWidth()) : n = 960,
            $.modal.close(),
            ...
            setTimeout(function() {
                $(".ph-installinstructions-body .VisitButtonContinueGLI a").removeClass("disabled").click(t, ft)
            }, 5e3),
            s(t)
        })
    }
    function ft(n) {
        var t = $(this);
        return t.hasClass("disabled") || (f(n.data),
        t.data("isedge") || $("#ProtocolHandlerClickAlwaysAllowed").show()),
        !1
    }
    function t(n) {
        return n.launchTime = +new Date,
        $(Roblox.GameLauncher).trigger(Roblox.GameLauncher.startClientAttemptedEvent, {
            launchMethod: "Protocol",
            params: n
        }),
        d(function() {}, n),
        $.when(nt(n), tt()).then(f, ot).then(ut).then(rt, it)
    }
    function ut(n) {
        var t = new $.Deferred;
    ...
    function rt(n) {
        ...
        r && ($(Roblox.GameLauncher).trigger(Roblox.GameLauncher.successfulInstallEvent, t),
        r = !1)
    }
    function it() {}
    function tt() {
    ...
    function f(t) {
        var u = new $.Deferred
          ...
          , e = "1";
        return i.push(e),
        i.push("launchmode:" + t.launchMode),
        i.push("gameinfo:" + encodeURIComponent(t.gameInfo)),
        n.protocolUrlIncludesLaunchTime && i.push("launchtime:" + t.launchTime),
    ...
    function g(t) {
        if (n.protocolDetectionEnabled && typeof navigator.msLaunchUri != "undefined")
            ...
            i.length > 0 && i.remove(),
            i = $("<iframe id='gamelaunch'></iframe>").attr("src", t),
            $("body").append(i)
        }
    }
    function i(n, t) {
    ...
    function k(n, t, i) {
        return o("Edit.ashx", n, t, i)
    }
    function st(n, t, i) {
        return o("Visit.ashx", n, t, i)
    }
    function o(n, t, i, r) {
        var u = " ", f, e, o;
    ...
    n = {
        ...
        joinMultiplayerGame: y,
        joinMultiplayerBuildGame: v,
        openStudio: b,
        editGameInStudio: w,
        buildGameInStudio: p,
