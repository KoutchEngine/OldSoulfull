...
<link rel="stylesheet" href="http://www.limrev.one/CSS/rbxcdn/Toolbox.css"/>


    <script type="text/javascript" src="http://www.limrev.one/js/jquery/jquery-1.11.1.min.js"></script>
<script type="text/javascript">window.jQuery || document.write("<script type='text/javascript' src='/js/jquery/jquery-1.11.1.js'><\/script>")</script>
<script type="text/javascript" src="http://www.limrev.one/js/jquery/jquery-migrate-1.2.1.min.js"></script>
<script type="text/javascript">window.jQuery || document.write("<script type='text/javascript' src='/js/jquery/jquery-migrate-1.2.1.js'><\/script>")</script>

    <script type="text/javascript" src="http://www.limrev.one/js/rbxcdn/Toolbox.js"></script>
...
<div id="image-retry-data" data-image-retry-max-times="10" data-image-retry-timer="1500" data-ga-logging-percent="10">
    ...
    <div ng-modules="pageTemplateApp">
        <script type="text/javascript" src="http://www.limrev.one/js/rbxcdn/Toolbox2.js"></script>
    </div>
</body>
