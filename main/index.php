<?php
    ...
    <ul id="AppStoreContainer" class="row text-center app-store-container row-five">
            <li>
                <a href="https://web.archive.org/web/20161209133303/https://itunes.apple.com/us/app/roblox-mobile/id431946152" target="_blank" class="app-store-link-apple">
                    <img class="app-store-logo" src="https://web.archive.org/web/20161209133303im_/https://images.rbxcdn.com/9819a104fc46fb90d183387ba81065a0.png" title="ROBLOX on App Store"/>
                </a>
            </li>
            <li>    
                <a href="https://web.archive.org/web/20161209133303/https://play.google.com/store/apps/details?id=com.roblox.client&amp;hl=en&amp;utm_source=global_co&amp;utm_medium=prtnr&amp;utm_content=Mar2515&amp;utm_campaign=PartBadge&amp;pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1" target="_blank" class="app-store-link-android">
                    <img class="app-store-logo android" src="https://web.archive.org/web/20161209133303im_/https://images.rbxcdn.com/c3f1d2562c735775d7fa2fc3ddb0dfdd.png" title="Get it on Google Play" alt="Get it on Google Play"/>
                </a>
            </li>
            <li>
                <a href="https://web.archive.org/web/20161209133303/http://amzn.com/B00NUF4YOA" target="_blank" class="app-store-link-amazon">
                    <img class="app-store-logo" src="https://web.archive.org/web/20161209133303im_/https://images.rbxcdn.com/29d56f5d7a8c1d6d4a267b28134e221d.png" title="ROBLOX on Amazon Store"/>
                </a>
            </li>
            <li>
                <a href="https://web.archive.org/web/20161209133303/http://store.xbox.com/en-US/Xbox-One/Games/ROBLOX/c79323fd-00f8-462a-a97a-39a0eb61791e" target="_blank" class="app-store-link-xbox">
                    <img class="app-store-logo" src="https://web.archive.org/web/20161209133303im_/https://images.rbxcdn.com/cfbff08ccdfe3e51898dfecf5635dc2a.png" title="ROBLOX on Xbox Store"/>
                </a>
            </li>
                <li>
                    <a href="https://web.archive.org/web/20161209133303/https://www.microsoft.com/en-us/store/games/roblox/9nblgggzm6wm" target="_blank" class="app-store-link-windows10">
                        <img class="app-store-logo" src="https://web.archive.org/web/20161209133303im_/https://images.rbxcdn.com/6e6e44a25ac2fc28a678880c2fec24a9.png" title="ROBLOX on Windows Store"/>
                    </a>
...
<meta name="google-site-verification" content="KjufnQUaDv5nXJogvDMey4G-Kb7ceUVxTdzcMaP9pCY"/>
    ...
    <meta property="og:url" content="https://www.<?php echo $url; ?>/"/>
    ...
    <link rel="canonical" href="https://www.<?php echo $url; ?>/"/>
    
    
<link rel="stylesheet" href="/CSS/SignUp/LeanBaseStyle.css"/>


            
<link rel="stylesheet" href="/CSS/SignUp/Landing.css"/>
...
<script type="text/javascript">window.jQuery || document.write("<script type='text/javascript' src='/js/jquery/jquery-migrate-1.2.1.js'><\/script>")</script>
    ...
    <script type="text/javascript" src="/js/rbxcdn/86411e39f51e0ef39c7fa2f1f92fe7b3.js"></script>
...
<style type="text/css">
    .coverSprite {
        ...
        background-image: url('/images/rbxcdn/20e7d1543d2c5caf201184d86530fc35.png');
    }

    #RollerContainer {
        background-image: url('/images/rbxcdn/dcbdfaf1c08058e71f65c09f7b98ff04.jpg');
        background-repeat: no-repeat;
    ...
    .special-dropdown select {
        ...
        -moz-appearance: none;
        background: url('/images/rbxcdn/379f4f1018f31cbb62ef52a22d9f2118.png') no-repeat;
    ...
    #InnerWhatsRobloxContainer1 {
        height: 70%;
        background-image: url('/images/rbxcdn/cca69eca62f23ca413fc920549e936ea.jpg');
        background-repeat: no-repeat;
        background-size: cover;
    ...
    #GameImage1 {
        background-image: url('/images/rbxcdn/42268b6264d89827401ef912f174f288.jpg');
        margin-right: 5px;
    }

    #GameImage2 {
        background-image: url('/images/rbxcdn/04baeb33ef66ef1395cd5464309fece6.jpg');
        margin-right: 5px;
    }

    #GameImage3 {
        background-image: url('/images/rbxcdn/e8b89d14690203420d64b5b2fda0b461.jpg');
        margin-right: -10px;
        ...
        <div class="row">
            <div class="navbar-header col-md-6">
                ...
                <div class="navbar-brand hidden-xs">
                    <img alt="Roblox Logo" class="robloxLogo" src="/images/rbxcdn/e870a0b9bcd987fbe7f730c8002f8faa.png"/>
                </div>
...
<div class="collapse navbar-collapse col-sm-6" id="LandingNavbar" ng-modules="roblox.formEvents">
    <form name="loginForm" action="https://www.<?php echo $url; ?>/newlogin" id="LogInForm" class="navbar-form form-inline navbar-right" method="post" role="form" rbx-form-context context="RollerCoaster" novalidate>
        ...
        <a id="HeaderForgotPassword" class="navbar-link" href="https://www.<?php echo $url; ?>/Login/ResetPasswordRequest.aspx">Forgot Username/Password?</a>
                ...
                <div class="col-xs-12 col-md-6">
                    <div id="MainLogo" class="text-right">
                        <div id="LogoAndSlogan" class="text-center">
                            <img id="MainLogoImage" title="ROBLOX" class="center-block img-responsive" src="/images/rbxcdn/39ae3ca577c8488487ef492031b8e264.png"/>
...
<script type="text/javascript">
    ...
    <script src="https://web.archive.org/web/20161209133303js_/https://www.google.com/recaptcha/api.js" async defer></script>


<style type="text/css">
    .male {
        background-image: url('/images/rbxcdn/856241927a2ac609e3033feada3ef9f9.png');
        background-repeat: no-repeat;
    }
    .female {
        background-image: url('/images/rbxcdn/a0afd0556163477e1023c5aa55d1b9f6.png');
        background-repeat: no-repeat;
    }
</style>
...
<img src="https://www.<?php echo $url; ?>/timg/rbx.png" style="position: absolute"/>
                        ...
                        <div class="rbx-select-group day">
                            <select class="input-field rbx-select" id="DayDropdown" tabindex="5" rbx-valid-birthday rbx-form-interaction rbx-form-validation name="birthdayDay" ng-model="signup.birthdayDay">
                                <option value="" disabled selected>Day</option>
                                    ...
                                    <option value="30" ng-show="isValidBirthday(30)">



                                        30
                                    </option>
                                    <option value="31" ng-show="isValidBirthday(31)">
            ...
            <div class="legal-text-container">
                By signing up you agree to our <a href="https://www.<?php echo $url; ?>/info/terms-of-service" target="_blank">Terms</a> and <a href="https://www.<?php echo $url; ?>/Info/Privacy.aspx" target="_blank">Privacy Policy</a>
            </div>
            ...
            <div class="captcha-container" ng-controller="CaptchaController" ng-form name="captchaForm" rbx-form-context context="RollerCoaster" ng-cloak ng-show="isSectionShown">
                <div class="g-recaptcha" data-sitekey="6LfGiSYTAAAAAPc4LIL1uV1J-4tHIu7CQ-M4baE5"></div>
                <button id="CaptchaSubmitButton" class="btn-primary-md signup-submit-button" data-signup-captcha-api-url="https://api.<?php echo $url; ?>/captcha/validate/signup" data-log-in-captcha-api-url="https://api.<?php echo $url; ?>/captcha/validate/login" ng-click="submitCaptcha($event)" ng-disabled="isSubmitting" rbx-form-interaction name="captchaSubmit">
                    Sign Up
                </button>
            </div>
            <button id="signup-button" type="button" tabindex="9" class="btn-primary-md signup-submit-button" rbx-form-interaction name="signupSubmit" ng-disabled="isSubmitting" ng-show="isSectionShown" data-signup-api-url="https://api.<?php echo $url; ?>/signup/v1" ng-click="submitSignup($event)" ng-keypress="submitSignup($event)">Sign Up</button>
            <noscript>
        ...
        <div class="row" id="DeviceImageContainer">
            <div class="col-md-12">
                <div class="row text-center">
                    <img id="ComputerImgSmall" class="center-block img-responsive hidden-lg ComputerImg" src="/images/rbxcdn/0ad1ae4bf929fb82cad6f30fdf03b6db.png"/>
                    <img class="center-block img-responsive visible-lg-block ComputerImg" src="/images/rbxcdn/9edeef823842e76479587a57c05cb5bc.png"/>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="footer">
        <ul class="row footer-links">
                <li class="col-4 col-xs-1 footer-link">
                    <a href="https://corp.<?php echo $url; ?>/" class="text-footer-nav roblox-interstitial" target="_blank">
                        About Us
                    </a>
                </li>
                <li class="col-4 col-xs-1 footer-link">
                    <a href="https://corp.<?php echo $url; ?>/jobs" class="text-footer-nav roblox-interstitial" target="_blank">
                        Jobs
                    </a>
                </li>
            <li class="col-4 col-xs-1 footer-link">
                <a href="https://blog.<?php echo $url; ?>/" class="text-footer-nav" target="_blank">
                    Blog
                </a>
            </li>
            <li class="col-4 col-xs-1 footer-link">
                <a href="https://corp.<?php echo $url; ?>/parents" class="text-footer-nav roblox-interstitial" target="_blank">
                    Parents
                </a>
            </li>
            <li class="col-4 col-xs-1 footer-link">
                <a href="https://en.help.<?php echo $url; ?>/" class="text-footer-nav roblox-interstitial" target="_blank">
                    Help
                </a>
            </li>
            <li class="col-4 col-xs-1 footer-link">
                <a href="https://www.<?php echo $url; ?>/Info/terms-of-service" class="text-footer-nav" target="_blank">
                    Terms
                </a>
            </li>
            <li class="col-4 col-xs-1 footer-link">
                <a href="https://www.<?php echo $url; ?>/Info/Privacy.aspx" class="text-footer-nav privacy" target="_blank">
                    Privacy
                </a>
            </li>
        </ul>
...
<script type="application/ld+json">
    ...
    "logo": "/images/rbxcdn/e870a0b9bcd987fbe7f730c8002f8faa.png",
    "sameAs" : [
    "https://www.youtube.com/thekoutchingalings"
    ]
    }
</script>
    ...
    <script type="text/javascript" src="/js/rbxcdn/6df9bc0534efbd8f409e764c1c275374.js"></script>


    
<script type="text/javascript" src="/js/rbxcdn/3b0c540bca77f11051d6358184298348.js"></script>
        <div ng-modules="baseTemplateApp">
            <script type="text/javascript" src="/js/rbxcdn/eccdbe4a2de694b92fc35ce9ecb30d6c.js"></script>
        </div>
...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="/js/rbxcdn/f0b07e9a299b010e3b2bdc2d5fa3f7b1.js"></script>
</body>
</html>